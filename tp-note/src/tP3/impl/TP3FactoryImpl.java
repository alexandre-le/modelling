...
public class TP3FactoryImpl extends EFactoryImpl implements TP3Factory {
	...
	public static TP3Factory init() {
		try {
			TP3Factory theTP3Factory = (TP3Factory)EPackage.Registry.INSTANCE.getEFactory(TP3Package.eNS_URI);
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case TP3Package.GRAPHE: return createGraphe();
			case TP3Package.SOMMET: return createSommet();
			case TP3Package.ARC: return createArc();
			default:
	...
	public Sommet createSommet() {
		SommetImpl sommet = new SommetImpl();
		return sommet;
	}
